    ...
    <div class="card-body border-bottom py-2">
        <form method="GET" action="{{ route('notes.index') }}" class="row g-2 align-items-center">
            ...
            <div class="col-auto">
                ...
                <a href="{{ route('notes.index') }}" class="btn btn-sm btn-ghost ms-1">Clear</a>
                @endif
            </div>
        </form>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title fw-600"><i class="bi bi-journal-plus text-primary me-2"></i>New Meeting Note</h6>
            ...
            <form method="POST" action="{{ route('notes.store') }}">
                ...
                <div class="modal-body">
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <label class="form-label fw-500" style="font-size:.85rem">Meeting Notes / Minutes *</label>
...
<div class="modal fade" id="editNoteModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title fw-600"><i class="bi bi-pencil text-primary me-2"></i>Edit Meeting Note</h6>
                <button class="btn-close" data-bs-dismiss="modal"></button>
            </div>
...
<div class="modal fade" id="viewNoteModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content border-0 shadow">
            <div class="modal-header border-0 pb-0">
                <h6 class="modal-title fw-600" id="vTitle"></h6>
                <button class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <div class="fw-600 mb-1" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.05em;color:#64748b">Notes / Minutes</div>
                    <div id="vContent" style="font-size:.875rem;white-space:pre-wrap;background:#f8fafc;border-radius:8px;padding:1rem"></div>
                </div>
                <div id="vActionItemsSection">
                    <div class="fw-600 mb-1" style="font-size:.8rem;text-transform:uppercase;letter-spacing:.05em;color:#64748b">Action Items</div>
...
<!-- Delete Form -->
<form id="deleteNoteForm" method="POST" class="d-none">@csrf @method('DELETE')</form>
